...
docker cp ./ocr-files/anand-blood-test.pdf t4re:/home/work/$TASK_TMP_DIR/
docker exec -it t4re /bin/bash -c "mkdir -p ./$TASK_TMP_DIR/out/; cd ./$TASK_TMP_DIR/out/; tesseract ../anand-blood-test.pdf phototest -l eng --psm 1 --oem 3 txt pdf hocr"
